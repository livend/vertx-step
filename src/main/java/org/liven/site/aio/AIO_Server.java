...
// nio2.0  since jdk1.7
// 参考： https://developer.aliyun.com/article/726698
public class AIO_Server {
    ...
    public static class AioServer implements Runnable {
    ...
    public static class AcceptHandler implements CompletionHandler<AsynchronousSocketChannel, AioServer> {
        @Override
        public void completed(AsynchronousSocketChannel result, AioServer attachment) {
            ...
            try {
                System.out.println("接受到连接请求:" + result.getRemoteAddress().toString());
